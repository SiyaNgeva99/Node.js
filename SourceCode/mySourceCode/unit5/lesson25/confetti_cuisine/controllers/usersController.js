...
module.exports = {
  ...
  login: (req, res) => {
    res.render("users/login");  // Add an action to render my form for browser viewing.
  },
  ...
  authenticate: passport.authenticate("local", {  // Add authentication middleware with redirect and flashmessage options.
